...
/* support: 
 * https://forum.myrcon.com/showthread.php?7169-TrueBalancer2-BF3-BF4-0-5-RC
 * 
 * grizzlybeer
...
{
    public class TrueBalancer2 : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        {
            return "forum.myrcon.com/showthread.php?7169-TrueBalancer2-0-5-0-0";
        }
...
<h2>Description</h2>
    ...
    There are 3 major parts within TrueBalancer2:<br><br>
...
<p><center><font size=""+2""><a href=""http://youtu.be/hYG0NqjW5p0"" target=""_blank"" filter:Glow(color=#ff0000, strength=12);>TrueBalancer2 Part 1 of 3 - PlayerNumber Balancer</a><br>
<a href=""http://youtu.be/c5BhRIZYoFM"" target=""_blank"">TrueBalancer2 Part 2 of 3 - SkillScrambler</a><br>
<a href=""http://youtu.be/73a8_6jTHGU"" target=""_blank"">TrueBalancer2 Part 3 of 3 - BalancingGuard</a><br><br>
<a href=""http://www.phogue.net/forumvb/showthread.php?2866-TrueBalancer2-for-BF3-(CQ-Rush-TDM)-0-2-7-(30-05-2012)&p=25828&viewfull=1#post25828"" target=""_blank"">RECOMMENDED SETTINGS</a><br>
</font></center></p>
<br><br>
...
<a href=""http://www.phogue.net/forumvb/showthread.php?2866-TrueBalancer2-for-BF3-(CQ-Rush-TDM)-0-2-7-(30-05-2012)&p=25828&viewfull=1#post25828"" target=""_blank"">RECOMMENDED SETTINGS</a></p>
<br><br><br>
...
- FIX: Problem with StatsReset feature. This got fixed by calculating all values by TrueBalancer2.<br>
...
<b>0.3.3</b><br>
- ADDED: TrueBalancer2's own move/fmove - commands, to be able to move players, even if BalancingGuard is on.<br>
...
- FIX: Fixing TrueBalancer2, which could get crazy if a manual roundrestart/nextround was requested.<br>
...
";
        ...
        {
            this.ExecuteCommand("procon.protected.pluginconsole.write", "^bTrueBalancer2 ^2Enabled! " + GetPluginVersion());
            this.boolfirstwarningWL = false;
        ...
        public void OnPluginDisable()
        {
            ...
            this.ExecuteCommand("procon.protected.pluginconsole.write", "^bTrueBalancer2 ^1Disabled =(");
        }
        ...
        public void SetPluginVariable(string strVariable, string strValue)
        {
            ...
            if (strVariable == "Maximum number of players to fetch at each interval")
            {
                ...
                {
                    this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n ^8^bMaximum number of players to fetch must be between 0 and 3, inclusive!");
                    numPlayers = 1;
                }
                else if (numPlayers == 0)
                {
                    this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n ^1^bMaximum number of players to fetch set to 0, stats fetching is disabled!");
                }
                else if (numPlayers != this.intMaxPlayersToFetch)
                {
                    this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n ^0^bMaximum number of players to fetch set to " + numPlayers);
                }
            ...
            if (strVariable == "Enable Virtual Mode?" && Enum.IsDefined(typeof(enumBoolYesNo), strValue) == true)
            {
                ...
                if (this.boolVirtual)
                {
                    this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n ^1^bVirtual mode is ENABLED!^n^0 No player moves or say/yells will be sent to the game server.");
                }
            }
        ...
        public virtual void OnRoundOverTeamScores(List<TeamScore> teamScores)
        {
            ...
            */
            ...
            if (this.boolscramblebyadminroundend && this.strcurrentGametype != "SquadDeathMatch0")
            {
                ...
                this.boolscramblefailed = false;
                this.ExecuteCommand("procon.protected.tasks.add", "WaitScrambleTimer", "49", "1", "1", "procon.protected.plugins.call", "TrueBalancer2", "StartScrambler");
            }
        ...
        public override void OnServerInfo(CServerInfo csiServerInfo)
        {
            ...
            //this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n " + csiServerInfo.BlazeGameState);
            //this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n " + csiServerInfo.BlazePlayerCount);
    ...
    //              if ((this.intwonTickets <= intticketdiffrence || this.ynbScrambleMap == enumBoolYesNo.Yes)&& this.intCurrentRoundCount == 1){
            ...
            if (Check4Update == enumBoolYesNo.Yes)
            {
                try
                {
                    ...
                    if (DateTime.Compare(updatehelper, DateTime.Now) <= 0)
                    {
                        ...
                        latestversion = latestversion.Substring(latestversion.IndexOf("TrueBalancer2") + 13);

                        if (GetPluginVersion() != latestversion)
                        {
                            this.ExecuteCommand("procon.protected.pluginconsole.write", "TrueBalancer2: ^b^2UPDATE " + latestversion + " AVAILABLE");
                            this.ExecuteCommand("procon.protected.pluginconsole.write", "TrueBalancer2: your version: " + GetPluginVersion());
                            this.ExecuteCommand("procon.protected.pluginconsole.write", "TrueBalancer2: latest version " + latestversion);
                        }
                ...
                if (this.boolLevelStart && this.TSLevelStartWait.TotalSeconds > 30)
                {
                    ...
                    else if (strcurrentGametype != "")
                    {
                        if (this.boolgametype == false)
                        {
                            ...
                            this.ExecuteCommand("procon.protected.pluginconsole.write", "TrueBalancer2:  Still no data or GameMode not supported: " + "I" + strcurrentGametype + "I");
        ...
        #region TrueBalancer2 Functions

        public void DebugInfo(string DebugMessage)
        {
            if (ynbDebugMode == enumBoolYesNo.Yes)
            {
                this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n " + DebugMessage);
            }
        }
                    ...
                    if (this.intScoreTeamA > this.intminScore && this.intScoreTeamB > this.intminScore)
                    {
                        ...
                        if (this.boolneedbalance && this.booltimer == false)
                        {
                            ...
                            else
                            {
                                ...
                                this.ExecuteCommand("procon.protected.tasks.add", "WaitBalancingTimer", this.intTimerWait.ToString(), "1", "1", "procon.protected.plugins.call", "TrueBalancer2", "BalancingTimer");
                            }
                        }
                    }
                    else
        ...
        public void DebugInfoSkill(string DebugMessage)
        {
            ...
            {
                this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n " + DebugMessage);
                //TextWriter tw = new StreamWriter("TrueBalancer2.txt",true);
        ...
        public void StartScrambler()
        {
            ...
            if (this.dicPlayerCache.Count < CompareSlots)
            {
                ...
                //this.ExecuteCommand("procon.protected.tasks.add", "WaitScrambleTimer", "1", "1", "1",  "procon.protected.plugins.call", "TrueBalancer2", "ScrambleNow");
            }
            else
            {
                ...
                if (this.boolLevelStart && this.boolFirstOP)
                {
                    ...
                    if (this.ynbEnableScrambleNow == enumBoolYesNo.Yes)
                    {
                        if (!this.boolscrambleActive)
                        {
                            ...
                            this.ExecuteCommand("procon.protected.tasks.add", "WaitScrambleTimer", "3", "1", "1", "procon.protected.plugins.call", "TrueBalancer2", "StartScrambler");
                            //StartScrambler();
                ...
                if (this.boolLevelStart)
                {
                    ...
                    if (this.ynbScrambleMessage == enumBoolYesNo.Yes)
                    {
                        if (this.strScrambleRoundMsg != "")
                        {
                            ...
                            {
                                this.ExecuteCommand("procon.protected.send", "admin.say", this.strScrambleRoundMsg, "all");
                                this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n Teams will be scrambled at RoundEnd");
                            }
                            if (this.ynbYellScrambleManuall == enumBoolYesNo.Yes && !this.boolVirtual)
                            {
                                this.ExecuteCommand("procon.protected.send", "admin.yell", this.strScrambleRoundMsg, "30");
        ...
        public void LogMove(string MoveMsg)
        {
            ...
            {
                this.ExecuteCommand("procon.protected.pluginconsole.write", "^b^9TrueBalancer2:^n " + MoveMsg);
            }
        }
        ...
        public class BattlelogClient
        {
            ...
            private TrueBalancer2 plugin = null;

            public BattlelogClient(TrueBalancer2 plugin)
            {
                this.plugin = plugin;
            }
