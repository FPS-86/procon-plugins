...
{
    public class CLastKill : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        private string m_strLastKillString;

        public CLastKill()
        {
            this.m_strDisplay = "%pk% killed %pv% with a %wp% for the last kill!";
            this.m_strLastKillString = "";
        }

        public string GetPluginName()
        {
            return "Last Kill Tracker";
        }
        ...
        {
            return @"
<p>For support or to post comments regarding this plugin please visit <a href=""http://phogue.net/forum/viewtopic.php?f=13&t=972"" target=""_blank"">Plugin Thread</a></p>
...
<h2>Description</h2>
    <p>Shows last kill of round with a customizable message.</p>
...
";
        ...
        {
            this.ExecuteCommand("procon.protected.pluginconsole.write", "^bLast Kill Tracker Plugin ^2Enabled!");
        }

        public void OnPluginDisable()
        {
            this.ExecuteCommand("procon.protected.pluginconsole.write", "^bLast Kill Tracker Plugin ^1Disabled =(");
        }
        ...
        {
            if (strVariable.CompareTo("Custom Message") == 0)
            {
        ...
        public void OnPlayerKilled(Kill kKillerVictimDetails)
        {
            ...
            this.m_strLastKillString = this.m_strDisplay.Replace("%pk%", Killer.SoldierName).Replace("%pv%", Victim.SoldierName).Replace("%wp%", weaponUsedName);
        }
