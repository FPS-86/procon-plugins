...
{
    public class CTrueBalancerBF3 : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        public CTrueBalancerBF3()
        {
            ...
            //this.PlayersOnServer = new List<string>(new string[] {"Z1", "Z2", "HRPanter"});
            ...
            this.intwonTicketsCONQUEST = 25;
            this.strScrambleMessageCONQUEST = "SCRAMBLING teams next round. Ticketdifference too big.";
            ...
            this.intwonTicketsTDM = 20;
            this.intshowTicketsTDM = 50;
            this.strScrambleMessageTDM = "SCRAMBLING teams next round. Ticketdifference too big.";
...
";
        ...
        {
            this.ExecuteCommand("procon.protected.pluginconsole.write", "^bTrueBalancerBF3 ^2Enabled! " + GetPluginVersion());
            this.boolfirstwarningWL = false;
        ...
        public void OnPluginDisable()
        {
            ...
            this.ExecuteCommand("procon.protected.pluginconsole.write", "^bTrueBalancerBF3 ^1Disabled =(");
        }
        ...
        public List<CPluginVariable> GetDisplayPluginVariables()
        {
            ...
            lstReturn.Add(new CPluginVariable("6. Testing settings|Enable Virtual Mode?", this.ynbVirtualMode.GetType(), this.ynbVirtualMode));
        ...
        public List<CPluginVariable> GetPluginVariables()
        {
            ...
            lstReturn.Add(new CPluginVariable("RUSH-Player Threshold", this.intAllowDif.GetType(), this.intTreshRUSH));
            ...
            lstReturn.Add(new CPluginVariable("CQ-Player Threshold", this.intAllowDif.GetType(), this.intTreshCONQUEST));
            ...
            lstReturn.Add(new CPluginVariable("TDM-Player Threshold", this.intAllowDif.GetType(), this.intTreshTDM));
        ...
        public override void OnRestartLevel()
        {
            ...
            {
                if (this.dicPlayerCache[kvp.Key].playerWL == 0)
                {
        ...
        public virtual void OnRoundOverTeamScores(List<TeamScore> teamScores)
        {
            ...
            */
            ...
            this.DebugInfoSkill("^9Team1 Data: ^7TBValue: ^b" + this.TBvalueA.ToString("F1") + "^n^0 - Rank: ^b" + this.rankA.ToString("F2") + "^n^1 - Skill: ^b" + this.skillA.ToString("F2") + "^n^2 - SPM: ^b" + this.spmA.ToString("F2") + "^n^3 - SPMcombat: ^b" + this.spmcombatA.ToString("F2") + "^n^4 - K/D: ^b" + this.kdrA.ToString("F2"));
            this.DebugInfoSkill("^9Team2 Data: ^7TBValue: ^b" + this.TBvalueB.ToString("F1") + "^n^0 - Rank: ^b" + this.rankB.ToString("F2") + "^n^1 - Skill: ^b" + this.skillB.ToString("F2") + "^n^2 - SPM: ^b" + this.spmB.ToString("F2") + "^n^3 - SPMcombat: ^b" + this.spmcombatB.ToString("F2") + "^n^4 - K/D: ^b" + this.kdrB.ToString("F2"));
            ...
            if (this.boolscramblebyadminroundend && this.strcurrentGametype != "SquadDeathMatch0")
            {
                ...
                this.boolscramblefailed = false;
                this.ExecuteCommand("procon.protected.tasks.add", "WaitScrambleTimer", "49", "1", "1", "procon.protected.plugins.call", "CTrueBalancerBF3", "StartScrambler");
            }
            else if ((this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination0") || this.strcurrentGametype.Contains("Scavenger0") || this.strcurrentGametype.Contains("AirSuperiority0")) && this.ynbenableSkillCONQUEST == enumBoolYesNo.Yes)
            {
        ...
        public virtual void OnRoundOverPlayers(List<CPlayerInfo> lstPlayers)
        {
            ...
            foreach (KeyValuePair<string, CPlayerJoinInf> kvp in this.dicPlayerCache)
            {
                if (this.dicPlayerCache[kvp.Key].playerWL != 1)
                {
                    this.dicPlayerCache[kvp.Key].tobebalanced = true;
                }
            }
        ...
        public override void OnServerInfo(CServerInfo csiServerInfo)
        {
            ...
            if (this.strcurrentGametype.Contains("GunMaster") || this.strcurrentGametype.Contains("CaptureTheFlag0"))
            {
            ...
            if ((this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination0") || this.strcurrentGametype.Contains("Scavenger0") || this.strcurrentGametype.Contains("AirSuperiority0")) && this.boolLevelStart)
            {
            ...
            if (!this.boolmessagesent && (this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination0") || this.strcurrentGametype.Contains("Scavenger0") || this.strcurrentGametype.Contains("AirSuperiority0")) && this.ynbenableSkillCONQUEST == enumBoolYesNo.Yes && (this.intScoreTeamA < 40 || this.intScoreTeamB < 40))
            {
    ...
    //              if ((this.intwonTickets <= intticketdiffrence || this.ynbScrambleMap == enumBoolYesNo.Yes)&& this.intCurrentRoundCount == 1){
            ...
            if (!this.boolscrambleActive)
            {
                ...
                foreach (KeyValuePair<string, CPlayerJoinInf> kvp in this.dicPlayerCache)
                {
                    ...
                    foreach (CPlayerInfo cpiPlayer in lstPlayers)
                    {
                        ...
                        if (cpiPlayer.SoldierName == kvp.Key)
                        {
                            ...
                            if (this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination") || this.strcurrentGametype.Contains("Scavenger0") || this.strcurrentGametype.Contains("AirSuperiority0"))
                            {
                ...
                foreach (CPlayerInfo cpiPlayer in lstPlayers)
                {
                    ...
                    if (this.dicPlayerCache.ContainsKey(cpiPlayer.SoldierName) == true && this.dicPlayerCache[cpiPlayer.SoldierName].statsFetched)
                    {
                        ...
                        if (this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination") || this.strcurrentGametype.Contains("Scavenger") || this.strcurrentGametype.Contains("AirSuperiority0"))
                        {
                            if (this.ScrambleByCONQUEST == "Rank")
                            {
                    ...
                    else
                    {
                        ...
                        if (numStatsFetch > 0)
                        {
                            ...
                            stats = this.bclient.getPlayerStats(cpiPlayer.SoldierName);
                        ...
                        if ((((IList<string>)this.strAWhitelistComplete).Contains(cpiPlayer.SoldierName) || (((IList<string>)this.strAClantagWhitelist).Contains(stats.tag) && stats.tag != String.Empty)) && this.ynbWhitelist == enumBoolYesNo.Yes)
                        {
                            ...
                            CPlayerJoinInf newEntry = new CPlayerJoinInf(cpiPlayer.TeamID, 1, cpiPlayer.SquadID, DateTime.Now, cpiPlayer.Score, stats.rank, tempskill, tempspm, tempspmcombat, tempkdr, TBvalueTemp, ValueTemp, stats.tag, false);
                        ...
                        else
                        {
                            ...
                            {
                                CPlayerJoinInf newEntry = new CPlayerJoinInf(cpiPlayer.TeamID, 0, cpiPlayer.SquadID, DateTime.Now, cpiPlayer.Score, stats.rank, tempskill, tempspm, tempspmcombat, tempkdr, TBvalueTemp, ValueTemp, stats.tag, true);
                                newEntry.statsFetched = stats.statsFetched;
                                this.dicPlayerCache[cpiPlayer.SoldierName] = newEntry;
                                //this.dicPlayerCache.Add(cpiPlayer.SoldierName, newEntry);
                                //PlayersOnServer.Add(cpiPlayer.SoldierName);
                            ...
                            {
                                CPlayerJoinInf newEntry = new CPlayerJoinInf(cpiPlayer.TeamID, 0, cpiPlayer.SquadID, DateTime.Now, cpiPlayer.Score, stats.rank, tempskill, tempspm, tempspmcombat, tempkdr, TBvalueTemp, ValueTemp, stats.tag, false);
                                newEntry.statsFetched = stats.statsFetched;
                                this.dicPlayerCache[cpiPlayer.SoldierName] = newEntry;
                                //this.dicPlayerCache.Add(cpiPlayer.SoldierName, newEntry);
                                //PlayersOnServer.Add(cpiPlayer.SoldierName);
                ...
                {
                    if (this.dicPlayerCache[kvp1.Key].playerWL == 1)
                    {
            ...
            else
            {
                ...
                if (this.boolscrambleNow && this.boolRunOnList)
                {
                    ...
                    if (this.boolTeamsScrambled)
                    {
                        ...
                        this.DebugInfoSkill("Team1 Value: ^b^2" + afterscrambleValueA / afterscrambleTeamSizeA + "^9*^7" + afterscrambleTeamSizeA + "^n^9 --- Team2 Value: ^b^2" + afterscrambleValueB / afterscrambleTeamSizeB + "^9*^7" + afterscrambleTeamSizeB);
            ...
            if (!this.boolscrambleActive)
            {
                ...
                if (this.boolLevelStart == true && this.boolFirstOP == true)
                {
                    ...
                    if (this.ynbBalancingGuard == enumBoolYesNo.Yes && this.boolFirstOP && this.OnCommandMove.ContainsKey(strSoldierName) == false)
                    {
                        ...
                        if (this.dicPlayerCache[strSoldierName].teamID == 0 && this.dicPlayerCache[strSoldierName].playerWL != 1)
                        {
                            ...
                            if (!this.teamswitcher.Contains(strSoldierName))
                            {
                                ...
                                this.DebugInfoGuard("PlayerNumber --- Team US: ^0" + this.TeamA + "^9, Team RU: ^0" + this.TeamB);
                                this.DebugInfoGuard("Score --- US: ^0" + this.intScoreTeamA + "^9, RU: ^0" + this.intScoreTeamB);

                                if (sortValueA > sortValueB)
                                {
                                    this.DebugInfoGuard("Team ^0^bUS^9^n is the better team.");

                                    if (this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination") || this.strcurrentGametype.Contains("TeamDeathMatch") || this.strcurrentGametype.Contains("Scavenger") || this.strcurrentGametype.Contains("AirSuperiority0"))
                                    {
                                ...
                                {
                                    this.DebugInfoGuard("Team ^0^bRU^9^n is the better team.");
                                ...
                                this.DebugInfoGuard("Team US Data: ^7TBValue: ^b" + this.TBvalueA.ToString("F1") + "^n^0 - Rank: ^b" + this.rankA.ToString("F2") + "^n^1 - Skill: ^b" + this.skillA.ToString("F2") + "^n^2 - SPM: ^b" + this.spmA.ToString("F2") + "^n^3 - SPMcombat: ^b" + this.spmcombatA.ToString("F2") + "^n^4 - K/D: ^b" + this.kdrA.ToString("F2"));
                                this.DebugInfoGuard("Team RU Data: ^7TBValue: ^b" + this.TBvalueB.ToString("F1") + "^n^0 - Rank: ^b" + this.rankB.ToString("F2") + "^n^1 - Skill: ^b" + this.skillB.ToString("F2") + "^n^2 - SPM: ^b" + this.spmB.ToString("F2") + "^n^3 - SPMcombat: ^b" + this.spmcombatB.ToString("F2") + "^n^4 - K/D: ^b" + this.kdrB.ToString("F2"));
                        ...
                        else if (this.dicPlayerCache[strSoldierName].playerWL != 1 && this.TSLevelStartWait.TotalSeconds > 90)
                        {
                            ...
                            if (!this.teamswitcher.Contains(strSoldierName))
                            {
                                ...
                                if (this.BalancedPlayers.Contains(strSoldierName) == false)
                                {
                                    ...
                                    if (sortValueA > sortValueB) this.DebugInfoGuard("Team ^0^bUS^9^n is the better team." + "\n");
                                    else if (sortValueB > sortValueA) this.DebugInfoGuard("Team ^0^bRU^9^n is the better team." + "\n");
                                    else this.DebugInfoGuard("\n");
                                ...
                                {
                                    this.DebugInfoGuard("^5-= TB Automatically =- Team US: ^b" + this.TeamA + "^n --- Team RU: ^b" + this.TeamB);
                                ...
                                if (!this.BalancedPlayers.Contains(strSoldierName) && this.dicPlayerCache[strSoldierName].playerValue >= badplayer && scorediff >= (intScoreWTS * this.intTicketcount / 100) && playerdiff >= -1 && (this.strcurrentGametype.Contains("Rush") == false && this.strcurrentGametype.Contains("GunMaster") == false && this.strcurrentGametype.Contains("CaptureTheFlag0") == false))
                                {
                                    if (this.boolVirtual)
                                    {
                                ...
                                else if (!this.BalancedPlayers.Contains(strSoldierName) && (this.strcurrentGametype.Contains("Rush") == false && this.strcurrentGametype.Contains("GunMaster") == false && this.strcurrentGametype.Contains("CaptureTheFlag0") == false) && playerdiff >= -1 /*&& valuediff >= dblValueDiff*/ && ((this.dicPlayerCache[strSoldierName].playerValue >= goodplayer && toteam == betterteam && scorediff > 5) || (this.dicPlayerCache[strSoldierName].playerValue <= badplayer && toteam == otherteam && scorediff < -5)))
                                {
                                    if (this.boolVirtual)
                                    {
                                ...
                                else if (!this.BalancedPlayers.Contains(strSoldierName) && (this.strcurrentGametype.Contains("Rush") == true || this.strcurrentGametype.Contains("GunMaster") == true || this.strcurrentGametype.Contains("CaptureTheFlag0") == true) && playerdiff >= -1 /*&& valuediff >= dblValueDiff*/ && ((this.dicPlayerCache[strSoldierName].playerValue >= goodplayer && toteam == betterteam) || (this.dicPlayerCache[strSoldierName].playerValue <= badplayer && toteam == otherteam)))
                                {
                                    if (this.boolVirtual)
                                    {
                                        this.ExecuteCommand("procon.protected.pluginconsole.write", "^b[TB] VIRTUAL^n admin.movePlayer " + strSoldierName + " " + fromteam.ToString() + " " + this.dicPlayerCache[strSoldierName].playerSquad.ToString() + " false");
                        ...
                        else if (this.dicPlayerCache[strSoldierName].playerWL == 1)
                        {
                            this.DebugInfoGuard("^2^b" + strSoldierName + "^n is VIP.");
                        }
                    }
        ...
        public void OnPlayerKilled(Kill killInfo)
        {
            ...
            else if (this.boolwaitfordeath)
            {
                ...
                if (dicPlayerCache[victim.SoldierName].teamID == intFromTeam)
                {
                    ...
                    if (dicPlayerCache[victim.SoldierName].playerWL == 0)
                    {
                    ...
                    {
                        this.DebugInfo("^1Player ^b" + victim.SoldierName + "^n is VIP or has been allready moved once.");
                    }
                }
            }
        }
        ...
        public void CompareTeams()
        {
            ...
            if (!this.boolscrambleActive)
            {
                ...
                if (this.strcurrentGametype.Contains("Conquest") || this.strcurrentGametype.Contains("TankSuperiority0") || this.strcurrentGametype.Contains("Domination") || this.strcurrentGametype.Contains("Rush") || this.strcurrentGametype.Contains("GunMaster") || this.strcurrentGametype.Contains("Scavenger") || this.strcurrentGametype.Contains("AirSuperiority0") || this.strcurrentGametype.Contains("CaptureTheFlag0"))
                {
                    if (this.intScoreTeamA > this.intminScore && this.intScoreTeamB > this.intminScore)
                    {
                        ...
                        if (this.boolneedbalance && this.booltimer == false)
                        {
                            ...
                            else
                            {
                                ...
                                this.ExecuteCommand("procon.protected.tasks.add", "WaitBalancingTimer", this.intTimerWait.ToString(), "1", "1", "procon.protected.plugins.call", "CTrueBalancerBF3", "BalancingTimer");
                            }
                        }
                    }
                    else
        ...
        public void startBalancing()
        {
            ...
            foreach (KeyValuePair<string, CPlayerJoinInf> kvp in this.dicPlayerCache)
            {
                if (this.dicPlayerCache[kvp.Key].teamID == this.intFromTeam && this.dicPlayerCache[kvp.Key].playerWL == 0)
                {
        ...
        public void StartScrambler()
        {
            ...
            if (this.dicPlayerCache.Count < CompareSlots)
            {
                ...
                //this.ExecuteCommand("procon.protected.tasks.add", "WaitScrambleTimer", "1", "1", "1",  "procon.protected.plugins.call", "CTrueBalancerBF3", "ScrambleNow");
            }
            else
            {
                ...
                if (this.boolLevelStart && this.boolFirstOP)
                {
                    ...
                    if (this.ynbEnableScrambleNow == enumBoolYesNo.Yes)
                    {
                        if (!this.boolscrambleActive)
                        {
                            ...
                            this.ExecuteCommand("procon.protected.tasks.add", "WaitScrambleTimer", "3", "1", "1", "procon.protected.plugins.call", "CTrueBalancerBF3", "StartScrambler");
                            //StartScrambler();
        ...
        public void KeepAllSquads()
        {
            ...
            this.DebugInfoSkill("SortValue before adjustment: ^bTeam1: ^7" + TeamSizeA + "^9*^2" + AverageTeamA +
                "^9^n --- ^bTeam2: ^7" + TeamSizeB + "^9*^2" + AverageTeamB);
            ...
            this.DebugInfoSkill("SortValue ^bafter^n adjustment: ^bTeam1: ^7" + TeamSizeA + "^9*^2" + AverageTeamA +
                "^9^n --- ^bTeam2: ^7" + TeamSizeB + "^9*^2" + AverageTeamB);
        ...
        public void KeepClanMates()
        {
            ...
            this.DebugInfoSkill("SortValue ^bafter^n PLAYER adjustment: ^bTeam1: ^7" + TeamSizeA + "^9*^2" + AverageTeamA +
                "^9^n --- ^bTeam2: ^7" + TeamSizeB + "^9*^2" + AverageTeamB);
            ...
            if (squadadjust)
            {
                this.DebugInfoSkill("SortValue ^bafter^n SQUAD adjustment: ^bTeam1: ^7" + TeamSizeA + "^9*^2" + AverageTeamA +
                    "^9^n --- ^bTeam2: ^7" + TeamSizeB + "^9*^2" + AverageTeamB);
        ...
        public class BattlelogClient
        {
            ...
            private CTrueBalancerBF3 plugin = null;

            public BattlelogClient(CTrueBalancerBF3 plugin)
            {
                this.plugin = plugin;
            }
    ...
    class CPlayerJoinInf
    {
        ...
        public CPlayerJoinInf(int teamID, int playerWL, int playerSquad, DateTime Playerjoined, int score, double rank, double skill, double spm, double spmcombat, double kdr, double TBvalue, double playerValue, string tag, bool tobebalanced)
        {
            _TBvalue = TBvalue;
            _teamID = teamID;
            _playerWL = playerWL;
